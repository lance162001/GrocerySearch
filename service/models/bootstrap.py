...
def ensure_runtime_schema() -> None:
    ...
    _ensure_column("users", "newsletter_opt_in", "newsletter_opt_in BOOLEAN DEFAULT 1")
    ...
    _ensure_column("companies", "is_active", "is_active BOOLEAN DEFAULT 1")
    _ensure_column("stores", "is_active", "is_active BOOLEAN DEFAULT 1")
